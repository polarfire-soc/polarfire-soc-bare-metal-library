...
software configurations may require a change in you application code.
...
"mpfs-mmuart-interrupt renode all-harts debug.launch" which is configured for
Renode.

Alternatively, you can perform above two steps in one go by launching 
mpfs-mmuart-interrupt renode all-harts start-platform-and-debug.launch which
...
Build the project and launch the debug configuration named 
mpfs-mmuart-interrupt hw all-harts debug.launch which is configured for 
