...
mpfs-single-shot-irq renode hart0 start-platform-and-debug.launch which is 
configured for Renode. 

Please refer Working_with_renode.md file in the project directory for more info 
