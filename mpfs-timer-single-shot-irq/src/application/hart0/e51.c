 ...
 *
 * PolarFire SoC MSS Timer single shot irq example.
 *
...
/******************************************************************************
 * Instruction message. This message will be transmitted on to the UART terminal
...
uint8_t timer2_plic_IRQHandler()
{
    ...
    MSS_UART_polled_tx_string(&g_mss_uart0_lo,
                              "Timer_2 One shot interrupt example\r\n");
