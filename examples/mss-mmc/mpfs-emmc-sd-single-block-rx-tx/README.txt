================================================================================
           PolarFire SoC MSS eMMC SD Single Block Read and Write Application
================================================================================

This example project demonstrates the use of PolarFire SoC MSS eMMC SD host
controller. It reads and writes single block of data from/to the eMMC/SD
device. It is targeted PolarFire SoC FPGA family hardware platform.
...
"mpfs-emmc-sd-single-block-rx-tx hw-emulation hart0 debug.launch" which is
configured for PolarFire SoC hardware platform.
