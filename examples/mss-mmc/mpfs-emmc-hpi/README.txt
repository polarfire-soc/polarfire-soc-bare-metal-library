================================================================================
    PolarFire SoC MSS eMMC High Priority Interrupt(HPI) write application
================================================================================

This example project demonstrates the use of PolarFire SoC MSS eMMC with
High Priority Interrupt(HPI). To stop ongoing multiple block write transfers
to the eMMC device and resume a previously interrupted multiple block write
transfer to the eMMC device using the high priority interrupt.
