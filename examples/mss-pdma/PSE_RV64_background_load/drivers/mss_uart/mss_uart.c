 ...
 *
 * SVN $Revision: 11518 $
 * SVN $Date: 2019-06-24 16:57:49 +0530 (Mon, 24 Jun 2019) $
 */
...
#define MSS_UART2_HI_BASE           (MSS_UART_TypeDef*)0x28002000UL
#define MSS_UART3_HI_BASE           (MSS_UART_TypeDef*)0x28004000UL
#define MSS_UART4_HI_BASE           (MSS_UART_TypeDef*)0x28006000UL
...
uint8_t mmuart_u54_local_IRQHandler_11(void)
{
    ...
    /*This is not ideal implementation. UART driver must not be checking for
     * HARTIDs. This check needs to move to MPFS HAL it it needs to have
     * multiple local interrupt tables for each U54. This is know and will be
     * taken care in later version of HAL. Till then this code remains here*/
    if(1u == hart_id)
    {
        if (g_uart_axi_pos & 0x01u)
        {
