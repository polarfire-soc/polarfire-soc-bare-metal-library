...
#define H2F_MAPPING_INVALID 255
...
const uint8_t H2F_int_mapping[BUS_ERROR_UNIT_HART_4]= { \
    ...
    H2F_MAPPING_INVALID /*NoInterrupt_IRQn          = 0*/, \
    ...
    0x0A /*G5C_DEVRST_PLIC                          =82 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
    0x08 /*g5c_MESSAGE_PLIC                         =83 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
    0x0B /*USOC_VC_INTERRUPT_PLIC                   =84 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
    0x0B /*USOC_SMB_INTERRUPT_PLIC                  =85 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
    ...
    0x0B /*USOC_AXIC_US_PLIC                        =102 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
    0x0B /*USOC_AXIC_DS_PLIC                        =103 + OFFSET_TO_MSS_GLOBAL_INTS*/, \
