...
"mpfs-periodic-irq renode hart0 debug.launch" which is configured for Renode.
Alternatively, you can perform above two steps in one go by launching
mpfs-periodic-irq renode hart0 start-platform-and-debug.launch which
...
Build the project and launch the debug configuration named 
"mpfs-periodic-irq hw-emulation all-harts debug.launch" which is configured for 
