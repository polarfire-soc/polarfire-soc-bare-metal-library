 ...
 *
 */
void ddr_pll_config_rpc(void)
{
#if 0
	/* CFG_DDR_SGMII_PHY->SOFT_RESET_MAIN_PLL; */
	CFG_DDR_SGMII_PHY->PLL_CTRL_MAIN.PLL_CTRL_MAIN				= DDR_PLL_CTRL_USER_CONFIG | 0x01U;
	CFG_DDR_SGMII_PHY->PLL_REF_FB_MAIN.PLL_REF_FB_MAIN			= DDR_PLL_REF_FB_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_FRACN_MAIN.PLL_FRACN_MAIN			= DDR_PLL_FRACN_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_DIV_0_1_MAIN.PLL_DIV_0_1_MAIN		= DDR_PLL_DIV_0_1_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_DIV_2_3_MAIN.PLL_DIV_2_3_MAIN		= DDR_PLL_DIV_2_3_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_CTRL2_MAIN.PLL_CTRL2_MAIN			= DDR_PLL_CTRL2_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_CAL_MAIN.PLL_CAL_MAIN 				= DDR_PLL_CAL_USER_CONFIG;
	CFG_DDR_SGMII_PHY->PLL_PHADJ_MAIN.PLL_PHADJ_MAIN			= DDR_PLL_PHADJ_USER_CONFIG;
	...
	CFG_DDR_SGMII_PHY->SSCG_REG_2_MAIN.SSCG_REG_2_MAIN 			= DDR_PLL_SSCG_REG_2_USER_CONFIG;
