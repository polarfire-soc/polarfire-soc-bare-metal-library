...
#if !defined (LIBERO_SETTING_SGMII_INMUX0_REFCLKMUX)
/*Input mux selections */ 
#define LIBERO_SETTING_SGMII_INMUX0_REFCLKMUX    0x00000005UL
    /* CIMUX_GEN0_SEL                    [0:4]   RW value= 0x5 */ 
    /* CIMUX_GEN1_SEL                    [4:4]   RW value= 0x0 */ 
    /* CIMUX_GEN2_SEL                    [8:4]   RW value= 0x0 */ 
    /* CIMUX_GEN3_SEL                    [12:4]  RW value= 0x0 */ 
    /* CIMUX_GEN4_SEL                    [16:2]  RW value= 0x0 */ 
    /* CIMUX_GEN5_SEL                    [18:2]  RW value= 0x0 */ 
    /* CIMUX_REF0_SEL                    [20:4]  RW value= 0x0 */ 
    /* CIMUX_REF1_SEL                    [24:4]  RW value= 0x0 */ 
    /* CIMUX_REF2_SEL                    [28:4]  RW value= 0x0 */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_INMUX1_SMGIIMUX)
/*Input mux selections */ 
#define LIBERO_SETTING_SGMII_INMUX1_SMGIIMUX    0x00000005UL
    /* CIMUX_REF3_SEL                    [0:4]   RW value= 0x5 */ 
    /* CIMUX_REF4_SEL                    [4:4]   RW value= 0x0 */ 
    /* CIMUX_REF5_SEL                    [8:4]   RW value= 0x0 */ 
...
#endif
#if !defined (LIBERO_SETTING_SGMII_INMUX2_SPARE)
/*Configurable delay line selections */ 
#define LIBERO_SETTING_SGMII_INMUX2_SPARE    0x00000000UL
    /* CDMUX3_SEL                        [0:2]   RW value= 0x0 */ 
    ...
    /* RESERVE13                         [26:6]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_OUTMUX0_CLK_XCVR)
/*output mux selection */ 
#define LIBERO_SETTING_SGMII_OUTMUX0_CLK_XCVR    0x00002011UL
    /* COMUX0_SEL                        [0:4]   RW value= 0x1 */ 
    /* COMUX1_SEL                        [4:4]   RW value= 0x1 */ 
    /* COMUX2_SEL                        [8:4]   RW value= 0x0 */ 
    /* COMUX3_SEL                        [12:4]  RW value= 0x2 */ 
    /* COMUX4_SEL                        [16:4]  RW value= 0x0 */ 
    /* COMUX5_SEL                        [20:4]  RW value= 0x0 */ 
    /* COMUX6_SEL                        [24:4]  RW value= 0x0 */ 
    /* COMUX7_SEL                        [28:4]  RW value= 0x0 */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_OUTMUX1)
/*Feeder clocks enable */ 
#define LIBERO_SETTING_SGMII_OUTMUX1    0x00000000UL
...
#define LIBERO_SETTING_SGMII_SPARE0    0x00000000UL
    /* SPARE0                            [0:28]  RW value= 0x0 */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_IMIRROR_CTRL)
/*Imirror_control_selections */ 
#define LIBERO_SETTING_SGMII_IMIRROR_CTRL    0x00000000UL
    ...
    /* RESERVE16                         [23:9]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_IMIRROR_STAT)
/*Imirror_status_register */ 
#define LIBERO_SETTING_SGMII_IMIRROR_STAT    0x00000000UL
    ...
    /* RESERVE17                         [29:3]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_FMETER_ADDR)
/*Frequency_meter_address_selections */ 
#define LIBERO_SETTING_SGMII_FMETER_ADDR    0x00000000UL
    /* ADDR10                            [0:2]   RSVD */ 
    /* ADDR                              [2:4]   RW value= 0x0 */ 
    /* RESERVE18                         [6:26]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_FMETER_DATAW)
/*Frequency_meter_data_write */ 
#define LIBERO_SETTING_SGMII_FMETER_DATAW    0x00000000UL
    /* DATA                              [0:24]  RW value= 0x0 */ 
    /* STROBE                            [24:1]  W1P */ 
    /* RESERVE19                         [25:7]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_FMETER_DATAR)
/*Frequency_meter_data_read */ 
#define LIBERO_SETTING_SGMII_FMETER_DATAR    0x00000000UL
    /* DATA                              [0:24]  RO */ 
    /* RESERVE20                         [24:8]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_IMIRROR_TRIM)
/*Imirror TRIM Bits */ 
#define LIBERO_SETTING_SGMII_IMIRROR_TRIM    0x00000000UL
