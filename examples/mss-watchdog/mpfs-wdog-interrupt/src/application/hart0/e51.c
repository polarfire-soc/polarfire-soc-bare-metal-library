...
\r\n\
After HART0 Timeout event system reset is evoked; The program will terminate \r\n\
    ...
    if(hartid == 0)
    {
        ...
        while(1u)
        {
            ...
            if (0x50000u == icount)
            {
                ...
                snprintf((char *)display_buffer, sizeof(display_buffer), "WD0 value = %x\r\n", *(uint32_t*)0x20001000);
                uart_tx_with_mutex (&g_mss_uart0_lo, (uint64_t)&uart_lock, display_buffer);

                current_value = MSS_WD_current_value(MSS_WDOG1_LO);
                snprintf((char *)display_buffer, sizeof(display_buffer), "WD1 value = %x\r\n", *(uint32_t*)0x20101000);
                uart_tx_with_mutex (&g_mss_uart0_lo, (uint64_t)&uart_lock,  display_buffer);

                current_value = MSS_WD_current_value(MSS_WDOG2_LO);
                snprintf((char *)display_buffer, sizeof(display_buffer), "WD2 value = %x\r\n", *(uint32_t*)0x20103000);
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h0_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H0 MVRP Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h0_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H0 timeout Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h1_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H1 MVRP Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h1_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H1 timeout Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h0_plic_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H0 MVRP PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h0_plic_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H0 timeout PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h1_plic_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H1 MVRP PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h1_plic_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H1 timeout PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h2_plic_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H2 MVRP PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h2_plic_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H2 timeout PLIC\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h2_mvrp = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H2 MVRP Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
            ...
            {
                h2_triggered = 0;
                snprintf((char *)display_buffer, sizeof(display_buffer), "H2 timeout Local\r\n");
                uart_tx_with_mutex (&g_mss_uart0_lo,  (uint64_t)&uart_lock, display_buffer);
            }
        }
    }
