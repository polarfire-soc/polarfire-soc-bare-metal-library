...
/*RTC clock divider */ 
#define LIBERO_SETTING_MSS_RTC_CLOCK_CR    0x00000100UL
    /* PERIOD                            [0:12]  RW value= 0x100 */ 
#endif
#if !defined (LIBERO_SETTING_MSS_ENVM_CR)
/*ENVM AHB Controller setup */ 
#define LIBERO_SETTING_MSS_ENVM_CR    0x40050007UL
    /* CLOCK_PERIOD                      [0:6]   RW value= 0x7 */ 
