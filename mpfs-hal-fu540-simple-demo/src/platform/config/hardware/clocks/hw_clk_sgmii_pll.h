...
#define LIBERO_SETTING_SGMII_PLL_CTRL    0x00000000UL
    /* REG_POWERDOWN_B                   [0:1]   RW value= 0x0 */ 
    /* REG_RFDIV_EN                      [1:1]   RW value= 0x0 */ 
    /* REG_DIVQ0_EN                      [2:1]   RW value= 0x0 */ 
    ...
    /* LP_REQUIRES_LOCK                  [24:1]  RW value= 0x0 */ 
    /* LOCK                              [25:1]  RO */ 
...
#define LIBERO_SETTING_SGMII_PLL_CAL    0x00000000UL
    /* DSKEWCALCNT                       [0:3]   RW value= 0x0 */ 
    /* DSKEWCAL_EN                       [3:1]   RW value= 0x0 */ 
    /* DSKEWCALBYP                       [4:1]   RW value= 0x0 */ 
    /* RESERVE28                         [5:3]   RSVD */ 
    /* DSKEWCALIN                        [8:7]   RW value= 0x0 */ 
    /* RESERVE29                         [15:1]  RSVD */ 
    /* DSKEWCALOUT                       [16:7]  RO */ 
    /* RESERVE30                         [23:9]  RSVD */ 
#endif
...
/*PLL phase registers */ 
#define LIBERO_SETTING_SGMII_PLL_PHADJ    0x00000000UL
    /* PLL_REG_SYNCREFDIV_EN             [0:1]   RW value= 0x0 */ 
    /* PLL_REG_ENABLE_SYNCREFDIV         [1:1]   RW value= 0x0 */ 
    /* REG_OUT0_PHSINIT                  [2:3]   RW value= 0x0 */ 
    /* REG_OUT1_PHSINIT                  [5:3]   RW value= 0x0 */ 
    /* REG_OUT2_PHSINIT                  [8:3]   RW value= 0x0 */ 
    /* REG_OUT3_PHSINIT                  [11:3]  RW value= 0x0 */ 
...
/*SSCG registers 2 */ 
#define LIBERO_SETTING_SGMII_SSCG_REG_2    0x00000000UL
    /* INTIN                             [0:12]  RW value= 0x0 */ 
    /* INTMOD                            [12:12] RO */ 
    /* RESERVE02                         [24:8]  RSVD */ 
#endif
#if !defined (LIBERO_SETTING_SGMII_SSCG_REG_3)
/*SSCG registers 3 */ 
#define LIBERO_SETTING_SGMII_SSCG_REG_3    0x00000000UL
    /* SSE_B                             [0:1]   RW value= 0x0 */ 
