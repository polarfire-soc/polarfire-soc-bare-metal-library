...
#define CFM_CONTROL_REG_BUSY_MASK        0x01
#define CFM_CONTROL_REG_START_MASK       0x01
#define CFM_CONTROL_REG_STOP_BITS_SHIFT  0x01

#define CFM_CLK_SEL_MASK                 0x07


#define CFM_CLK_REFSEL0_MASK             0x01
#define CFM_CLK_REFSEL0SHIFT             0x04 //Changed


#define CFM_CLK_REFSEL1_MASK             0x01
#define CFM_CLK_REFSEL1SHIFT             0x05 //Changed


#define CFM_CLK_MONSEL_MASK              0x07
#define CFM_CLK_MONSEL_SHIFT             0x08//Changed



#define CFM_CLK_MONEN_MASK               0x01
#define CFM_CLK_MONEN_SHIFT              11 //Changed

#define CFM_RUNTIME_REG_MASK             0xFFFFFF

#define CFM_CHANNEL_MODE_MASK            0x3

#define CFM_CH0_SHIFT_MASK           0x00
#define CFM_CH1_SHIFT_MASK           0x02
#define CFM_CH2_SHIFT_MASK           0x04
#define CFM_CH3_SHIFT_MASK           0x06
#define CFM_CH4_SHIFT_MASK           0x08
#define CFM_CH5_SHIFT_MASK           0x0A
#define CFM_CH6_SHIFT_MASK           0x0C
#define CFM_CH7_SHIFT_MASK           0x0E
