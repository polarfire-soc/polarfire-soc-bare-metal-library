...
mpfs-pdma-read-write renode all-harts start-platform-and-debug.launch which is 
...
Build the project and launch the debug configuration named 
mpfs-pdma-read-write hw-emulation all-harts debug.launch which is configured for 
